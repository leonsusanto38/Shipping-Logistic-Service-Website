    ...
    function cekongkir() {
        $.confirm({
            ...
            content: '' +
                ...
                '<label for="resi" style="font-size: 12pt;"><b>Kota Asal</b></label>' +
                ...
                '</div><br>' +
                '<div class="form-group">' +
                '<label for="resi" style="font-size: 12pt;"><b>Kota Tujuan</b></label>' +
                '</center><select class="form-control" id="asal" style="height:40px; font-size: 12pt;">' +
                ...
                '</div><br>' +
                '<div class="form-group">' +
                '<label for="resi" style="font-size: 12pt;"><b>Kategori Berat Barang (kg)</b></label>' +
                '</center><select class="form-control" id="asal" style="height:40px; font-size: 12pt;">' +
    ...
    <header class="header-area overlay">
        ...
        <div class="banner">
            <div class="container">
                ...
                <button class="button button-primary" onclick="cekongkir()">Click Here</button>
            </div>
        </div>
    </header>
